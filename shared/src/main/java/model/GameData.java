...
public record GameData(int gameID, String whiteUsername, String blackUsername, String gameName, ChessGame game,
    ...
    public GameData makeMove(String username, ChessMove move) throws InvalidMoveException {
        ...
        return setState(State.UNDECIDED, String.format("%s moved %s. %s's turn.",
                username, move, game.getTeamTurn()));
    }
    ...
    public void validateTurn(String username) throws InvalidMoveException {
        ...
        if (game.getTeamTurn() == BLACK && !username.equals(blackUsername) ||
                game.getTeamTurn() == WHITE && !username.equals(whiteUsername)) {
    ...
    public GameData setState(State state, String description) {
        return new GameData(this.gameID, this.whiteUsername, this.blackUsername,
                this.gameName, this.game, state, description);
    }
